...
public class PrototypeHero : MonoBehaviour {
    ...
    [SerializeField] GameObject m_DodgeDust;
    ...
    void Update ()
    {
        ...
        if (inputRaw > 0 && !m_dodging)
        {
            GetComponent<SpriteRenderer>().flipX = false;
            m_facingDirection = 1;
        }
            
        else if (inputRaw < 0 && !m_dodging)
        {
        ...
        //Attack
        else if (Input.GetMouseButtonDown(0) && !m_dodging && m_timeSinceAttack > 0.03f)
        {
        ...
        // Dodge
        else if (Input.GetKeyDown("left shift") && m_grounded && !m_dodging)
        {
            m_dodging = true;
        ...
        //Jump
        else if (Input.GetButtonDown("Jump") && m_grounded && !m_dodging && m_disableMovementTimer < 0.0f)
        {
